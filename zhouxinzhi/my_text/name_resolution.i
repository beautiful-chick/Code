...
# 1 "/usr/include/arm-linux-gnueabihf/bits/getopt_ext.h" 1 3 4
# 27 "/usr/include/arm-linux-gnueabihf/bits/getopt_ext.h" 3 4

# 50 "/usr/include/arm-linux-gnueabihf/bits/getopt_ext.h" 3 4
struct option
{
  const char *name;
...
# 305 "/usr/include/arm-linux-gnueabihf/bits/socket.h" 3 4
extern struct cmsghdr *__cmsg_nxthdr (struct msghdr *__mhdr,
          struct cmsghdr *__cmsg) __attribute__ ((__nothrow__ , __leaf__));
# 332 "/usr/include/arm-linux-gnueabihf/bits/socket.h" 3 4
enum
  {
    SCM_RIGHTS = 0x01
...
# 354 "/usr/include/arm-linux-gnueabihf/bits/socket.h" 3 4
...
# 2 "/usr/include/arm-linux-gnueabihf/asm/sockios.h" 2 3 4
# 7 "/usr/include/asm-generic/socket.h" 2 3 4
# 2 "/usr/include/arm-linux-gnueabihf/asm/socket.h" 2 3 4
# 355 "/usr/include/arm-linux-gnueabihf/bits/socket.h" 2 3 4
...
# 23 "name_resolution.c" 2


# 24 "name_resolution.c"
...
char** webn_toaddr(char *name)
{
 struct hostent *host_ip;
 char **pptr = 
# 35 "name_resolution.c" 3 4
                     ((void *)0)
# 35 "name_resolution.c"
                         ;
 char str[32];
 char **rv = 
# 37 "name_resolution.c" 3 4
                  ((void *)0)
# 37 "name_resolution.c"
                      ;

 if (name == 
# 39 "name_resolution.c" 3 4
            ((void *)0)
# 39 "name_resolution.c"
                )
 {
  printf("webn_toaddr argument error[%s]\n",strerror(
# 41 "name_resolution.c" 3 4
                                                    (*__errno_location ())
# 41 "name_resolution.c"
                                                         ));
        return 
# 42 "name_resolution.c" 3 4
              ((void *)0)
# 42 "name_resolution.c"
                  ;
 }

 host_ip =(struct hostent *) malloc(sizeof(struct hostent));
 memset(host_ip,0,sizeof(struct hostent));
 if ( (host_ip = gethostbyname(name)) < 0)
 {
  printf("error[%s]",strerror(
# 49 "name_resolution.c" 3 4
                             (*__errno_location ())
# 49 "name_resolution.c"
                                  ));
  return 
# 50 "name_resolution.c" 3 4
        ((void *)0)
# 50 "name_resolution.c"
            ;
 }
# 61 "name_resolution.c"
 printf("official hostname:%s\n",host_ip->h_name);

 for(pptr = host_ip->h_aliases ; *pptr != 
# 63 "name_resolution.c" 3 4
                                         ((void *)0) 
# 63 "name_resolution.c"
                                              ; pptr++)
 {
 ...
 {
  case 
# 71 "name_resolution.c" 3 4
      2
# 71 "name_resolution.c"
             :
  case 
# 72 "name_resolution.c" 3 4
      10
# 72 "name_resolution.c"
              :
   pptr = host_ip->h_addr_list;
   for(;*pptr!=
# 74 "name_resolution.c" 3 4
              ((void *)0)
# 74 "name_resolution.c"
                  ;pptr++)
   {
...
# 81 "name_resolution.c" 3 4
                                        (*__errno_location ())
# 81 "name_resolution.c"
                                             ));
   break;
 }
...
int main(int argc,char *argv[])
{
    int choo = -1;
 char *webname = 
# 92 "name_resolution.c" 3 4
                       ((void *)0)
# 92 "name_resolution.c"
                           ;
 char buf[32];
 ...
 {
  {"help",
# 97 "name_resolution.c" 3 4
         0
# 97 "name_resolution.c"
                    ,
# 97 "name_resolution.c" 3 4
                     ((void *)0)
# 97 "name_resolution.c"
                         ,'h'},
        {"net_name",
# 98 "name_resolution.c" 3 4
                   1
# 98 "name_resolution.c"
                                    ,
# 98 "name_resolution.c" 3 4
                                     ((void *)0)
# 98 "name_resolution.c"
 ...
 char **webaddr = 
# 101 "name_resolution.c" 3 4
                        ((void *)0)
# 101 "name_resolution.c"
                            ;

 while( (choo = getopt_long(argc,argv,"hn:",opts,
# 103 "name_resolution.c" 3 4
                                                ((void *)0)
# 103 "name_resolution.c"
                                                    )) != -1 )
 {
  switch(choo)
  {
 ...
 if (webname == 
# 116 "name_resolution.c" 3 4
               ((void *)0)
# 116 "name_resolution.c"
                   )
 {
  printf_help(argv[0]);
  return -1;
 ...
 printf("%s\n",inet_ntop(
# 125 "name_resolution.c" 3 4
                        2
# 125 "name_resolution.c"
                               ,*webaddr,buf,sizeof(buf)));
